...
import { Camera, ChevronRight, RotateCcw, X } from "lucide-react";
...
const BOARD_STORY_COUNT = 15; // 홈 보드를 채우는 목표 스토리 수(실 스토리 + 껍데기)
...
export const MemoryFeed = () => {
  ...
  // 실 스토리 뒤에 부족분만큼 껍데기를 붙여 홈 보드를 항상 BOARD_STORY_COUNT개로 채움(스토리 탭에는 영향 없음)
  ...
  return (
    <div className={styles.feed}>
      {/* 1. 스토리 콜라주 보드 (캔버스를 시원하게 확대하고 내부 레이아웃을 띄웁니다) */}
      <div className={styles.board} ref={boardRef}>
        {/* 2. 상단 플로팅 종합 정보 대시보드 카드 (오버레이 상단 배치) */}
        <div className={styles.infoCard}>
          <div className={styles.infoCardTop}>
            <div className={styles.workspaceInfo}>
              ...
              <div className={styles.dDayRow}>
                ...
                <span className={styles.memberNames}> · {memberNamesString}</span>
              </div>
            </div>
            <button
              type="button"
          ...
          {nextEvent && (
            <>
              ...
              >
                <span className={styles.eventLabel}>가장 가까운 기념일</span>
        ...
        {/* 🌟 하단 플로팅 퀵 버튼들 오버레이 */}
        <div className={styles.quickAccessOverlay}>
          <QuickAccessRow />
        </div>
